...
- [ ] **Scaffold MockFunctionContext private state**
...
- [ ] **Scaffold MockTracker private registry**
...
- [ ] **Implement central invoke path on MockFunctionContext**
...
- [ ] **Implement callCount() and getCall()**
...
- [ ] **Implement mockImplementationOnce()**
...
- [ ] **Wire `times` option auto-restore**
  - **Story**: `times` option
...
- [ ] **Implement restore() for fn mocks**
...
- [ ] **Implement MockTracker.method() for regular methods**
...
- [ ] **Extend method() with getter/setter support**
...
- [ ] **Implement MockTracker.restoreAll()**
...
- [ ] **Export MockTracker from the public entry**
...
- [ ] **Tests: MockTracker.fn() basics and validation**
...
- [ ] **Tests: CallContext capture (error, this, constructor)**
...
- [ ] **Tests: mockImplementation / mockImplementationOnce / times**
